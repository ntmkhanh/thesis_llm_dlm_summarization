...
def parse_args():
    p = argparse.ArgumentParser(description="Train GENIE-style conditional latent diffusion")
    ...
    p.add_argument("--output-dir", default="outputs/models/genie")
    return p.parse_args()
...
def main():
    ...
    torch.save(
        ...
        os.path.join(args.output_dir, "genie_denoiser.pt"),
    )
    ...
    print(f"Saved GENIE model to {args.output_dir}")
