...
DEFAULT_DRAFT_DIR = "outputs/drafts/llama_cnn_dailymail"


def parse_args():
    p = argparse.ArgumentParser(description="Generate LLaMA draft summaries for a CNN-only CNN/DailyMail split")
...
def default_output(split: str) -> str:
    return f"{DEFAULT_DRAFT_DIR}/llama_{split}_drafts.csv"
